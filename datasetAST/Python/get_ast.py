...
if __name__ == '__main__':
    ...
    gen_all_ast_py(code_split_dir='C:\Users\DELL\mtechproject material\TEST Models\6 run\datasetAST\Python',
                ast_file_path='C:\Users\DELL\mtechproject material\TEST Models\6 run\datasetAST\Python')
